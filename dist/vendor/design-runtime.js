...
(() => {
  ...
  var BASE_CSS = `
    ...
    html.sc-dc-streaming .sc-interp.sc-missing::before{content:'';
      ...
      background:linear-gradient(90deg,rgba(138,73,56,0) 25%,rgba(245,242,235,.95) 37%,rgba(138,73,56,0) 63%);
    ...
    .sc-logic-error{position:absolute;top:8px;left:8px;z-index:2147483647;max-width:60ch;
      padding:6px 10px;background:#8a4938;color:#f5f2eb;font:12px/1.4 ui-monospace,monospace;
  ...
  var CANVAS_BG_LIGHT = "#efebe1";
  var CANVAS_BG_DARK = "#252827";
